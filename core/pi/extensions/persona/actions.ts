...
export function buildSystemSetupBlock(): string {
	return [
		...
		"Guide the user through git identity setup for the operator checkout they plan to use (for example `/srv/nixpi`), or through path-independent global git config, plus admin-tailnet setup, OS security configuration, and a short NixPI tutorial.",
