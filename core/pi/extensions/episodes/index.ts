...
/**
 * episodes — Append-only episodic memory in ~/Garden/Episodes/.
 *
...
export default function (pi: ExtensionAPI) {
	const tools: RegisteredExtensionTool[] = [
		defineTool({
			...
			description: "Append a markdown episode under ~/Garden/Episodes/ for later memory consolidation.",
		...
		defineTool({
			name: "episode_list",
			label: "Episode List",
			description: "List stored markdown episodes under ~/Garden/Episodes/.",
			parameters: Type.Object({
		...
		defineTool({
			...
			description: "Promote a stored episode into a durable memory object in ~/Garden/Objects/.",
			parameters: Type.Object({
