...
const SETUP_STATE_PATH = join(os.homedir(), ".garden", "setup-state.json");
const SETUP_COMPLETE_PATH = join(os.homedir(), ".garden", ".setup-complete");
...
export async function touchPersonaDone(): Promise<void> {
	const markerPath = join(os.homedir(), ".garden", "wizard-state", "persona-done");
