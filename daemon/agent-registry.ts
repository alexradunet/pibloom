...
function normalizeAgentDefinition(
	...
	const cooldownMs =
		typeof respondObj?.cooldown_ms === "number" ? respondObj.cooldown_ms : DEFAULT_COOLDOWN_MS;
	...
	return {
		...
		...(normalizeTools(attributes.tools, instructionsPath) ? { tools: normalizeTools(attributes.tools, instructionsPath) } : {}),
	};
}
...
function normalizeThinking(
	value: unknown,
	instructionsPath: string,
): AgentDefinition["thinking"] | undefined {
