/**
 * objects — Flat-file object store with YAML frontmatter in ~/Garden/Objects/.
 *
...
export default function (pi: ExtensionAPI) {
	const tools: RegisteredExtensionTool[] = [
		defineTool({
			name: "memory_create",
			label: "Memory Create",
			description: "Create a new markdown object in ~/Garden/Objects/",
			parameters: Type.Object({
				...
				path: Type.Optional(
					Type.String({
						description: "Optional file path relative to home dir (default: Garden/Objects/{slug}.md)",
					}),
				),
			}),
		...
		defineTool({
			name: "memory_update",
			label: "Memory Update",
			description: "Update an existing markdown object in ~/Garden/Objects/",
			parameters: Type.Object({
		...
		defineTool({
			name: "memory_upsert",
			label: "Memory Upsert",
			description: "Create or update a markdown object in ~/Garden/Objects/",
			parameters: Type.Object({
				type: Type.String({ description: "Object type" }),
				slug: Type.String({ description: "Object slug" }),
				fields: Type.Optional(Type.Record(Type.String(), fieldValueSchema)),
		...
		defineTool({
			name: "memory_read",
			label: "Memory Read",
			description: "Read a markdown object from ~/Garden/Objects/",
			parameters: Type.Object({
				type: Type.String({ description: "Object type" }),
				slug: Type.String({ description: "Object slug" }),
				path: Type.Optional(Type.String({ description: "Optional direct file path relative to home dir" })),
		...
		defineTool({
			...
			parameters: Type.Object({
				...
				directory: Type.Optional(Type.String({ description: "Directory to walk (default: ~/Garden/Objects/)" })),
