...
This page is the documentation hub for Garden.

## 📚 Reference Map

| Topic | Audience | Primary question | Main doc |
|------|----------|------------------|----------|
| Platform overview | both | what is Garden | [../README.md](../README.md) |
...
| Build, image, and VM flows | operators | how to build and boot Garden | [quick_deploy.md](quick_deploy.md) |
| Fresh-device validation | operators | how to verify a release candidate | [live-testing-checklist.md](live-testing-checklist.md) |
| Memory model | maintainers | how Garden stores and promotes memory | [memory-model.md](memory-model.md) |
| Contribution workflow | maintainers | how Garden prepares local repo changes for human review | [fleet-pr-workflow.md](fleet-pr-workflow.md) |
